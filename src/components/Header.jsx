  ...
  return (
      <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black">
         ...
         <div className="flex h-5 items-center">
              ...
              <Link to="/" className="flex h-5 ml-3 items-center">
                 <img className="h-5 hidden md:block" src={ytLogo} alt="Youtube"/>
                 <img className="h-5 md:hidden" src={ytLogoMobile} alt="Youtube"/>
              </Link>
          </div>
